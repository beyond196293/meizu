...
<div class="panel admin-panel">
  ...
  <table class="table table-hover text-center">
    ...
    <?php if(is_array($list)): foreach($list as $key=>$val): ?><tr>
      ...
      <td><img src="/shoppingobject/Public/Uploads/<?php echo ($val["image"]); ?>" alt="" width="80" height="50" /></td>     
    ...
    <?php if(is_array($lis)): foreach($lis as $key=>$asd): ?><tr>
      ...
      <td><img src="/shoppingobject/Public/Uploads/<?php echo ($asd["image"]); ?>" alt="" width="80" height="50" /></td>     
