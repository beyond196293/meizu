  ...
  <div class="body-content">
    <form method="post" class="form-x" action="" enctype="multipart/form-data">   
      ...
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="name" value="<?php echo ($list["name"]); ?>" />         
          <div class="tips"></div>
        </div>
      </div> 
      <div class="form-group">
        ...
        <div class="field">
          <input type="text" class="input w50" name="link" value="<?php echo ($list["link"]); ?>" data-validate="required:请输入标题" />
          <div class="tips"></div>
        </div>
      </div> 
     <div class="form-group">
