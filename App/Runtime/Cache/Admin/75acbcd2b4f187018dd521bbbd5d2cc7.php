...
<div class="panel admin-panel margin-top">
  ...
  <div class="body-content">
      <form method="post" class="form-x" action="<?php echo U('Admin/Notice/noticeup');?>">   
      ...
      <div class="form-group">
        ...
        <div class="field">
            <textarea type="text" class="input" name="content" style="height:100px;" ><?php echo ($info["content"]); ?></textarea>        
        </div>
     </div>
     <div class="form-group">
        <div class="label">
