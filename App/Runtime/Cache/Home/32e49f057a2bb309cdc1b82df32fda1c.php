...
<div class="layout-header clearfix">
    ...
    <div class="crumbs">
        ...
        <a href="<?php echo U('Home/Index/index');?>">我的商城&gt;</a>
        <a href="" class="active">My购物车</a>
    </div>
</div>
<div id="tableList" class="type-contain ui-load-container">
			<div class="ui-load-content J_no_data">
				<p class="J_no_data_des">您的购物车是空的，赶快去购物吧！</p>
				<div style="width:500px;margin-left:470px;"><img width="400px" src="/obj/Public/Home/images/11.png" /></div>
			</div>
</div>
