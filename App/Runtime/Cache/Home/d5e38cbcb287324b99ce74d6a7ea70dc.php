...
<div class="layout-header clearfix">
	...
	<link rel="stylesheet" href="/obj/Public/Home/css/layout-ea436a570a.css">
	<link rel="stylesheet" href="/obj/Public/css/bootstrap.min.css" media="screen" />    
	<link rel="stylesheet" href="/obj/Public/Home/css/bootstrap-theme.min.css" />
	<link rel="stylesheet" href="/obj/Public/Home/css/bootstrap.css" />
	<script type="text/javascript" src="/obj/Public/Home/js/bootstrap.js"></script>
	<script type="text/javascript" src="/obj/Public/Home/js/bootstrap.min.js"></script>
	<script type="text/javascript" src="/obj/Public/Home/js/jquery.min.js"></script><link rel="stylesheet" href="/obj/Public/Home/css/site-base.css">
    <link rel="stylesheet" href="/obj/Public/Home/css/aio.css">
<div class="store-wrap">
    <div class="crumbs">
        <a href="http://store.meizu.com/">首页&gt;</a>
        <a href="http://me.meizu.com/member/index">我的商城&gt;</a>
        <a href="http://me.meizu.com/member/favorite/index" class="active">我的收藏</a>
    </div>
    ...
    <div class="left-nav f-fl">
        ...
        <div class="right-content f-fr">
            ...
            <div class="collect-main">
                ...
                <div class="clearfix">
                <?php if(is_array($info)): foreach($info as $key=>$val): ?><div style="z-index: 18;" class="item j-hover-item f-fl">
                <!--<i class="icon-del j-icon-del"></i>-->
                <a id="del<?php echo ($key); ?>" onclick="del(<?php echo ($key); ?>)"><img class="icon-del j-icon-del" src="/obj/Public/Home/images/del.png"></a>
                <a href="<?php echo U('Home/Details/index?id='.$val['id']);?>" target="_blank">
                    <img src='/obj/Public/Uploads/<?php echo ($val["savepath"]); ?>' alt="魅族 MX5e 经典版">
                </a>
                <a href="http://detail.meizu.com/item/meizu_mx5e.html" target="_blank">
...
<script>
    function del(a){
    $.get("<?php echo U('Home/Collect/del');?>",{'id':a},function(result){
    //alert(a);
    $("#del"+a).parent().empty().remove();
},'json');
}
</script>
