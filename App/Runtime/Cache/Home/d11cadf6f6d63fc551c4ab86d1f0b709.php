...
<head>
	...
	<link rel="stylesheet" href="/mz_shop/Public/Home/css/style3.css">

	<link rel="stylesheet" href="/mz_shop/Public/Home/css/iconfont.css">

	<script src="/mz_shop/Public/Home/js/jquery2.js"></script>
		...
		<div class="box-con tran">
			...
			<div class="login-con f-l">
                ...
                <div class="form-group">
                     ...
                     <input style="width:200px" type="text" name="yzm"  placeholder="验证码"><img src="<?php echo U('yzm');?>" width="100px" height="30px" onclick="this.src='/mz_shop/index.php/Home/Login/yzm/id='+Math.random()">
				...
				<div class="form-group">
					...
					<a href="javascript:;" class="move-other a-tag tran">使用第三方帐号登录<i class="iconfont tran">&#xe06;</i></a>
			...
			<div class="signup f-l">
                <form action="<?php echo U('Home/Login/signup');?>" method="post">

				<div class="form-group">

					<div class="signup-form">

						<input type="text" name="name" placeholder="邮箱" class="email-mobile" onblur="verify.verifyEmail(this)">
